...
VHEADERS := $(filter-out ${BSG_F1_DIR}/hardware/bsg_bladerunner_rom_pkg.vh,$(VHEADERS) $(VSOURCES))
VSOURCES := $(filter-out $(BSG_QCL_DIR)/hdl/bsg_bladerunner_rom_pkg.v,$(VHEADERS) $(VSOURCES))
...
# VHEADERS := $(filter-out ${BSG_F1_DIR}/hardware/cl_manycore.sv,$(VHEADERS) $(VSOURCES))
...
VSOURCES += $(BSG_QCL_DIR)/hdl/xilinx_ip/axi4_mux2.v
