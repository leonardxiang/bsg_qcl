...
set PRJECT_PATH       [lindex $argv 1]

# fix the compiling order for xilinx vivado
...
set XILINX_EX_DIR $env(QCL_REPO_DIR)/hdl/xilinx_ip
...
# generate ips
# =====================================
set PRJ_IP_DIR ${PRJECT_PATH}/${DESIGN_NAME}.srcs/sources_1/ip
...
CONFIG.EN_SAFETY_CKT {true}] [get_ips blk_mem_gen_0]
generate_target {instantiation_template} [get_files ${PRJ_IP_DIR}/blk_mem_gen_0/blk_mem_gen_0.xci]
set_property generate_synth_checkpoint false [get_files  ${PRJ_IP_DIR}/blk_mem_gen_0/blk_mem_gen_0.xci]
generate_target all [get_files  ${PRJ_IP_DIR}/blk_mem_gen_0/blk_mem_gen_0.xci]
